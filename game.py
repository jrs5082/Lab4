...
def display_room(room):
    ...
    30-36 Newport Road. The cashier looks
    at you with hope
...
def print_menu(exits):
    ...
    rooms = [north_room, east_room, south_room, west_room]

    print("You can:")
    print_menu_line("north", north_room)
    print_menu_line("east", east_room)
    print_menu_line("south", south_room)
    print_menu_line("west", west_room)
...
def menu(exits):
    ...
    while True:
        ...
        move(rooms["Reception"]["exits"], "west")
        ...
        if checked_user_input == True:
            ...
            choice = input("Your choice isn't possible. Enter another choice.")
